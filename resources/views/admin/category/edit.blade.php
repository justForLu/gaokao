    ...
    <div class="layui-form" lay-filter="layuiadmin-form-category" id="layuiadmin-form-category" style="padding: 20px 30px 0 0;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" value="{{$data->name}}" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-upload">
                    ...
                    <div class="layui-upload-list">
                        <img src="{{$data->image}}" class="layui-upload-img" id="category-upload-normal-img" style="width: 150px; height: 150px;">
                        <p id="test-upload-demoText"></p>
                    </div>
                    <input type="hidden" name="image" value="{{$data->image}}" id="category_image_path">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
