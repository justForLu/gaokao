    ...
    <div class="layui-form" lay-filter="layuiadmin-form-enter_line" id="layuiadmin-form-enter_line" style="padding: 20px 30px 0 0;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="year" value="{{$data->year}}" class="layui-input" lay-verify="required" id="enter_line-laydate-year" autocomplete="off" placeholder="yyyy">
            </div>
        </div>
        <div class="layui-form-item">
