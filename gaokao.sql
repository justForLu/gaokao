...
INSERT INTO `zh_article` VALUES (5, '什么是物流专业2', 1, '什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2', '<p>什么是物流专业2</p><p><br></p>', 12, 1, 0, 0, 1, 1618624235, 1619344945);
COMMIT;
...
CREATE TABLE `zh_log` (
  ...
  `create_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=632 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台日志表';
