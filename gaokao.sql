...
-- ----------------------------
BEGIN;
INSERT INTO `zh_article` VALUES (1, '什么是生物工程', 1, '', '<h2 style=\"text-align: center;\"><p><span style=\"font-size: 14px;\">最新公告</span><br></p></h2><p><br></p>', 11, 1, 0, 0, 1, 1610004808, 1619344811);
INSERT INTO `zh_article` VALUES (2, '什么是车辆工程', 1, '', '<h2 style=\"text-align: center;\"><p><br></p></h2><p>最新公告</p><p><br></p>', 11, 1, 0, 0, 1, 1610004808, 1619344811);
INSERT INTO `zh_article` VALUES (3, '什么是土木工程', 1, '', '<h2 style=\"text-align: center;\"><span style=\"font-size: 14px;\">这是平台公告</span><br></h2><p><br></p>', 11, 1, 0, 0, 1, 1610674828, 1619344811);
INSERT INTO `zh_article` VALUES (4, '什么是物联网专业', 1, '', '<p style=\"text-align: center;\">&nbsp; &nbsp; &nbsp;&nbsp;</p><p>放的地方是第三方</p>', 15, 1, 0, 0, 1, 1610674883, 1619344882);
INSERT INTO `zh_article` VALUES (5, '什么是物流专业2', 1, '什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2什么是物流专业2', '<p>什么是物流专业2</p><p><br></p>', 14, 1, 0, 0, 1, 1618624235, 1619603774);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zh_banner` VALUES (1, '首页轮播图1', '/upload/admin/image/2021-04/25/20210425094624696798.jpg', '', 1, 1, 0, 1, 1609222155, 1619315186);
INSERT INTO `zh_banner` VALUES (2, '首页轮播图2', '/upload/admin/image/2021-04/25/20210425094635651122.jpg', '', 1, 1, 0, 1, 1609212455, 1619315197);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zh_category` VALUES (1, '专业解读', '', 1, 1, 0, 1618978308, 0);
INSERT INTO `zh_category` VALUES (2, '经济学类（本）', '', 2, 1, 0, 1618978308, 1618978319);
INSERT INTO `zh_category` VALUES (3, '财政学类(本)', '', 2, 1, 0, 1618978308, 1618978313);
...
CREATE TABLE `zh_feedback` (
  ...
  `update_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='投诉建议表';
...
INSERT INTO `zh_feedback` VALUES (3, '张三', '15948756858', '', '测是测试测试测试测试', 0, '', 0, 0, 1619771781, 0);
INSERT INTO `zh_feedback` VALUES (4, '张三', '15958478695', '', '测试测试测试测试测试测试测试测试', 0, '', 0, 0, 1619771866, 0);
INSERT INTO `zh_feedback` VALUES (5, '张三', '15954876589', '', '测试测试测试测试测试测试测试', 0, '', 0, 0, 1619773467, 0);
INSERT INTO `zh_feedback` VALUES (6, '张三', '15969856985', '', '测试测试测试测试测试测试测试', 0, '', 0, 0, 1619773488, 0);
INSERT INTO `zh_feedback` VALUES (7, '张三', '15968659864', '', '测试测试测试测试测试测试', 0, '', 0, 0, 1619773589, 0);
INSERT INTO `zh_feedback` VALUES (8, '22', '15969865874', '', 'ces ces ces ces ces ces ces', 0, '', 0, 0, 1619773666, 0);
COMMIT;
...
CREATE TABLE `zh_log` (
  ...
  `create_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=637 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台日志表';
...
INSERT INTO `zh_log` VALUES (618, 1, 'login', 'login', '/admin/login', '登录后台', '124.67.176.67', 1, 1619178246);
INSERT INTO `zh_log` VALUES (619, 1, 'login', 'login', '/admin/login', '登录后台', '116.115.205.198', 1, 1619227186);
INSERT INTO `zh_log` VALUES (620, 1, 'login', 'login', '/admin/login', '登录后台', '127.0.0.1', 1, 1619250151);
INSERT INTO `zh_log` VALUES (621, 1, 'banner', 'update', '/admin/banner/1', '更新轮播图', '127.0.0.1', 1, 1619250282);
INSERT INTO `zh_log` VALUES (622, 1, 'banner', 'update', '/admin/banner/2', '更新轮播图', '127.0.0.1', 1, 1619250299);
INSERT INTO `zh_log` VALUES (623, 1, 'login', 'login', '/admin/login', '登录后台', '127.0.0.1', 1, 1619315147);
INSERT INTO `zh_log` VALUES (624, 1, 'banner', 'update', '/admin/banner/1', '更新轮播图', '127.0.0.1', 1, 1619315186);
INSERT INTO `zh_log` VALUES (625, 1, 'banner', 'update', '/admin/banner/2', '更新轮播图', '127.0.0.1', 1, 1619315197);
INSERT INTO `zh_log` VALUES (626, 1, 'login', 'login', '/admin/login', '登录后台', '127.0.0.1', 1, 1619345243);
INSERT INTO `zh_log` VALUES (627, 1, 'login', 'login', '/admin/login', '登录后台', '127.0.0.1', 1, 1619410481);
INSERT INTO `zh_log` VALUES (628, 1, 'login', 'login', '/admin/login', '登录后台', '223.88.75.246', 1, 1619421868);
INSERT INTO `zh_log` VALUES (629, 1, 'school', 'update', '/admin/school/1', '更新高校', '127.0.0.1', 1, 1619422326);
INSERT INTO `zh_log` VALUES (630, 1, 'school', 'update', '/admin/school/2', '更新高校', '127.0.0.1', 1, 1619422348);
INSERT INTO `zh_log` VALUES (631, 1, 'school', 'update', '/admin/school/3', '更新高校', '127.0.0.1', 1, 1619422407);
INSERT INTO `zh_log` VALUES (632, 1, 'school', 'update', '/admin/school/1', '更新高校', '127.0.0.1', 1, 1619426220);
INSERT INTO `zh_log` VALUES (633, 1, 'school', 'update', '/admin/school/3', '更新高校', '127.0.0.1', 1, 1619426303);
INSERT INTO `zh_log` VALUES (634, 1, 'login', 'login', '/admin/login', '登录后台', '127.0.0.1', 1, 1619577037);
INSERT INTO `zh_log` VALUES (635, 1, 'school', 'update', '/admin/school/3', '更新高校', '127.0.0.1', 1, 1619577273);
INSERT INTO `zh_log` VALUES (636, 1, 'login', 'login', '/admin/login', '登录后台', '127.0.0.1', 1, 1619763576);
COMMIT;
...
CREATE TABLE `zh_major` (
  ...
  `update_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='高校专业';
...
INSERT INTO `zh_major` VALUES (3, 2, 2, '国际经济与贸易', 1, 2, 4, NULL, 0, 0, 0);
INSERT INTO `zh_major` VALUES (4, 2, 2, '国际经济与贸易', 1, 2, 4, NULL, 0, 0, 0);
INSERT INTO `zh_major` VALUES (5, 2, 2, '国际经济与贸易', 1, 2, 4, NULL, 0, 0, 0);
INSERT INTO `zh_major` VALUES (6, 2, 2, '国际经济与贸易', 1, 2, 4, NULL, 0, 0, 0);
INSERT INTO `zh_major` VALUES (7, 2, 2, '国际经济与贸易', 1, 2, 4, NULL, 0, 0, 0);
COMMIT;
...
CREATE TABLE `zh_school` (
  ...
  `logo` varchar(255) NOT NULL DEFAULT '' COMMENT '高校logo',
